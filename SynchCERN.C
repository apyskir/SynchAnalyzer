...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      hBJet1Pt->Fill(bpt_1);
      hBJet1Phi->Fill(bphi_1);
      hBJet1Eta->Fill(beta_1);
      hBJet2Pt->Fill(bpt_2);
      ...
      //hJdPhi->Fill(jdphi);
      //extra lepton vetos
      hDiLeptonVeto->Fill(dilepton_veto);
      hExtraElectronVeto->Fill(extraelec_veto);
      hExtraMuonVeto->Fill(extramuon_veto);
   }
}
